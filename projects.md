...
<section class="portfolio-hero">
  <p class="eyebrow">Apps, experiments and ideas</p>
  <h1 class="display-title">Small tools with <span class="soft">a clear point of view.</span></h1>
  <p class="portfolio-intro">Each app starts with something I want to make simpler, calmer or more enjoyable — then grows through native design, careful details and plenty of iteration.</p>
</section>
...
<section class="product-section">
  <div class="section-heading"><h2>From the archive</h2></div>
  <div class="archive-list">
    <a class="archive-item" href="/resurfer/"><strong>ReSurfer</strong><span>A minimal Reddit client for iPhone and iPad →</span></a>
    <div class="archive-item"><strong>ToDot</strong><span>A small, focused to-do list.</span></div>
    <div class="archive-item"><strong>Purse</strong><span>A simple expense tracker.</span></div>
  </div>
</section>
